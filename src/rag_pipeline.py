...
SYNONYMS = {
    "siniestro": {"accidente", "choque", "colision", "reclamo"},
    "accidente": {"siniestro", "choque", "colision"},
    "choque": {"siniestro", "accidente", "colision"},
    "colision": {"siniestro", "accidente", "choque"},
    "deducible": {"franquicia", "seguro"},
    "franquicia": {"deducible"},
    "cobertura": {"cubre", "amparo", "proteccion", "coberturas"},
    "coberturas": {"cobertura", "cubre", "amparo"},
    "cubre": {"cobertura", "amparo", "proteccion"},
    "exclusion": {"exclusiones", "excluye", "limitacion"},
    "exclusiones": {"exclusion", "excluye"},
    "reembolso": {"reembolsar", "reembolsos", "reintegro", "devolucion"},
    "reembolsos": {"reembolso", "reembolsar", "reintegro"},
    "prima": {"primas", "cuota", "mensualidad", "pago"},
    "primas": {"prima", "cuota", "mensualidad"},
    "poliza": {"polizas", "contrato", "vigencia"},
    "grua": {"auxilio", "remolque", "asistencia", "rescate"},
    "auxilio": {"grua", "remolque", "asistencia"},
    "taller": {"talleres", "reparacion", "servicio", "mecanico"},
    "robo": {"hurto", "sustraccion"},
    "telefono": {"numero", "contacto", "central", "emergencia"},
    "numero": {"telefono", "contacto"},
    "denuncia": {"denunciar", "aviso", "reclamo"},
    "vigencia": {"poliza", "contrato", "validez"},
}
